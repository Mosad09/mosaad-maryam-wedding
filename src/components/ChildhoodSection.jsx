    ...
    <section className="py-20 px-6 bg-ivory dark:bg-dark">
      <div className="max-w-lg mx-auto text-center">
        <motion.div
          ...
          className="group inline-block bg-warmwhite p-3 pb-6 gold-border shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-sm"
        >
          <div className="overflow-hidden">
            <img
              ...
              loading="lazy"
              className="w-72 h-72 md:w-80 md:h-80 object-cover transition-transform duration-500 group-hover:scale-[1.05]"
            onError={(e) => {
              e.currentTarget.src =
